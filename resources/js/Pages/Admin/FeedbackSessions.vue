...
<template>
    <Head title="Session Feedback - Admin" />

    <AdminLayout>
        <div class="space-y-6">
            <!-- Header -->
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Session Feedback</h1>
                <p class="mt-2 text-sm text-gray-600">View and analyze feedback for all training sessions</p>
            </div>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            v-model="searchQuery"
                            type="text"
                            placeholder="Search by session, course, or trainer..."
                        ...
                        <div class="flex-1 space-y-3">
                            ...
                            <div class="grid gap-4 md:grid-cols-3">
                                ...
                                <div class="flex items-center gap-2 text-sm text-gray-600">
                                    ...
                                    <span class="truncate">{{ session.trainer_name || 'N/A' }}</span>
                                </div>
                                <div class="flex items-center gap-2 text-sm text-gray-600">
